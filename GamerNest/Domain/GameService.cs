...
namespace Domain
{
    public class GameService
    {
        ...
        public static void CreateGame(string title = "", string subtitle = "", string description = "", string language = "", string cover = "", string releaseDate = "", bool isFav = false, int idDev = -1, int idPlatform = -1, int idPublisher = -1, List<int> idGenre = null, List<int> idPlayerType = null, List<int> idLanguageGame = null)
        {
            sbyte isFav2 = Utility.BoolToSByte(isFav);

            GameRepository.CreateGame( title, subtitle, description, language, cover, releaseDate, isFav2, idDev, idPlatform, idPublisher, idGenre, idPlayerType, idLanguageGame );
        }

        public static void UpdateGame(int id = -1, string title = "", string subtitle = "", string description = "", string language = "", string cover = "", string releaseDate = "", bool isFav = false, int idDev = -1, int idPlatform = -1, int idPublisher = -1, List<int> idGenre = null, List<int> idPlayerType = null, List<int> idLanguageGame = null)
        {
            sbyte isFav2 = Utility.BoolToSByte(isFav);

            GameRepository.UpdateGame( id, title, subtitle, description, language, cover, releaseDate, isFav2, idDev, idPlatform, idPublisher, idGenre, idPlayerType, idLanguageGame );
        }

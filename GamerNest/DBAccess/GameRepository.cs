    ...
    public class GameRepository
    {
        public static DataTable GetAllGames(string language = "", string user = "", int idArticle = -1, int id = -1, string title = "", string subtitle = "", int idPlatform = -1, string orderBy = "")
        {
            try
            {
                using ( MySqlCommand cmd = Data.CreateCommand() )
                {
                    ...
                    queryBuilder.Append( "SELECT game.id, game.title, game.subtitle, game.description, game.language, game.cover, game.releaseDate, 0 as 'isFav', game.idDev, dev.name as 'dev', game.idPlatform, platform.name as 'platform', platform.icon as 'platformIcon', game.idPublisher, publisher.name as 'publisher'" );
        ...
        public static DataTable GetGame(int id)
        {
            try
            {
                using ( MySqlCommand cmd = Data.CreateCommand() )
                {
                    cmd.CommandText = "SELECT game.id, game.title, game.subtitle, game.description, game.language, game.cover, game.releaseDate, game.isFav, game.idDev, dev.name as 'dev', game.idPlatform, platform.name as 'platform', platform.icon as 'platformIcon', game.idPublisher, publisher.name as 'publisher'"
        ...
        public static long CreateGame(string title = "", string subtitle = "", string description = "", string language = "", string cover = "/img/Cover/Game/Default.png", string releaseDate = "", sbyte isFav = 0, int idDev = -1, int idPlatform = -1, int idPublisher = -1, List<int> idGenre = null, List<int> idPlayerType = null, List<int> idLanguageGame = null)
        {
            try
            {
        ...
        public static long UpdateGame(int id = -1, string title = "", string subtitle = "", string description = "", string language = "", string cover = "", string releaseDate = "", sbyte isFav = 0, int idDev = -1, int idPlatform = -1, int idPublisher = -1, List<int> idGenre = null, List<int> idPlayerType = null, List<int> idLanguageGame = null)
        {
            try
            {
